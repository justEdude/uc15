...
public class ListaTurno extends javax.swing.JFrame {
 ...
 private void preencherTabela(List<turnos> vez){
        
        String colunas[] = {"id", "nome", "Periodo", "Data", "Inicio", "Fim"};
        ...
        for(turnos f : vez){
            ...
            Linha[i] = new String[]{
                ...
                f.getNome(),
                f.getPeriodo(),
                String.valueOf(f.getData()),
                String.valueOf(f.getInicio()),
                String.valueOf(f.getFim()),
    ...
    private void botaoPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoPesquisaActionPerformed
           ...
           List<turnos> cenario = dao.turnos(campoPesquisa.getText());
